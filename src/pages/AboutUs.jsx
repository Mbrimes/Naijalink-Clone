...
const AboutUs = () => {
	return (
		<>
			<div class="nav" style={{ backgroundImage: `url(${rd})` }}>
				<nav class="navbar">
					<div class="logo">
	...
	<div class="abos">
		<h2>About Us</h2>
		<p>Naijalink Ltd was founded in 2009 with the mission to link international companies with reputable companies and qualified opportunities in Nigeria, thereby creating value for our clients as well in Nigeria. We link you with Naija, the 'new' Nigeria: young, dynamic and incredibly entrepreneurial. Supported by our knowledge, experience and extensive network, our clients will gain access to real and promising business opportunities.
		</p>
		<p>The company is owned and run by the Dutch consultant/ investor/ economist <span><a href="https://www.linkedin.com/in/thessabagu"> Thessa Bagu </a></span> who has lived in Nigeria since 2006. She is supported by an ever-expanding team of <strong> skilled and motivated </strong> young professionals.</p>
		<p>Learn more about our services and company by watching this interview with our MD Thessa Bagu on TVC Communications:<a href="https://Naijalink.eu/"> https://www.youtube.com/watch?v=ZbNmN_Zx84E&feature=youtu.be</a></p> 
	</div> 
